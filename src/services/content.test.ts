...
describe("content service", () => {
    ...
    describe("processArticle", () => {
        it("process an article with all transformations", () => {
            const result = processArticle(sampleArticle, 50);

            // This is an INTEGERATION test - it test multiple units working together
        ...
        it("uses the default excerpt length when not specified", () => {
    ...
    describe("processArticles", () => {
        ...
        it("returns and empty array for an empty input", () => {
